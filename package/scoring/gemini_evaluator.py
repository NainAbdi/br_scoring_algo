...
class GeminiEvaluator:
    ...
    def _parse_enhanced_evaluation(self, response_text: str) -> Dict[str, float]:
        ...
        try:
            ...
            total_score = (
                (technical_accuracy * WRITTEN_ANSWER_CRITERIA["technical_accuracy"]) +
                (problem_solving_methodology * WRITTEN_ANSWER_CRITERIA["problem_solving_methodology"]) +
                (logical_thinking * WRITTEN_ANSWER_CRITERIA["logical_thinking"]) +
                (clarity * WRITTEN_ANSWER_CRITERIA["clarity"]) +
                (presentation * WRITTEN_ANSWER_CRITERIA["presentation"])
            )
            
            return {
                "technical_accuracy": technical_accuracy,
                "problem_solving_methodology": problem_solving_methodology,
            ...
            raise Exception(f"Failed to parse enhanced evaluation response: {str(e)}")
    ...
    def _parse_legacy_evaluation(self, response_text: str) -> Dict[str, float]:
        ...
        try:
            ...
            total_score = (technical_accuracy * LEGACY_WRITTEN_ANSWER_CRITERIA["technical_accuracy"]) + (clarity * LEGACY_WRITTEN_ANSWER_CRITERIA["clarity"])
