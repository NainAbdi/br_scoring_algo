...
SKILL_SCORING_CONFIG: Dict[str, Dict] = {
    ...
    # Electrical Engineering Field-Specific Skills
    "circuit_design": {
        "components": ["written_answers"],
        "weights": [1.0],
        "written_answer_criteria": ["technical_accuracy", "problem_solving_methodology"]
    },
    "power_systems": {
        "components": ["written_answers"],
        "weights": [1.0],
        "written_answer_criteria": ["technical_accuracy", "logical_thinking"]
    },
    "control_systems": {
        "components": ["written_answers"],
        "weights": [1.0],
