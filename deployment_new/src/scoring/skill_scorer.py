...
class SkillScorer:
    ...
    async def calculate_field_skill_scores(
        self, 
        submission: AssessmentSubmission, 
        openai_evaluator: OpenAIEvaluator,
        ...
        """
        Calculate scores for specific field skills.
        
        Args:
            submission: The assessment submission data
            openai_evaluator: The AI evaluator for written answers
            field_skills: List of skill names to calculate for this field
        ...
        # Calculate scores for each field skill
        for skill_name in field_skills:
